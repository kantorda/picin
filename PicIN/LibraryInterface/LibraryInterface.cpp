...
namespace LibraryInterface {
	Void Interface::ProcessImage(String^ path, [Runtime::InteropServices::Out] String^% luminocity,
	...
	{
		List<List<String^>^>^ data = Core::Processor::processImage(marshal_as<std::string>(path));
